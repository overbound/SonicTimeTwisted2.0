...
// animation
if state!=1 and state !=5 and state!=2 image_index = (objScreen.image_index*0.5) mod 2;

}
/// set on fire
if place_meeting(x,y+6,objLava) || place_meeting(x,y+6,objLavaSeep) {
    state = 5;
    hspeed=0;
    sprite_index = sprAntnikBurn;
    image_speed = .25;
}
