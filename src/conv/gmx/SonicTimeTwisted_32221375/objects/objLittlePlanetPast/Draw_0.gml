...
draw_sprite_ext(sprLittlePlanetPastAdd, 0, fx, fy, image_xscale, image_yscale, image_angle, image_blend, .65);
draw_set_blend_mode(bm_normal);
draw_sprite_ext(sprLittlePlanetPastRing, 0, fx, fy, image_xscale, image_yscale, image_angle, image_blend, .65);
