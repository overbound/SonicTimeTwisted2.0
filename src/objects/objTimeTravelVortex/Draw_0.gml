...
if not surface_exists(tt_surface) tt_surface = surface_create(objScreen.width, objScreen.height);
...
timetravel_shader_draw(objScreen.width, objScreen.height, x, y);
