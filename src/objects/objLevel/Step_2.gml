...
with objCamera instance_activate_region(camera_get_view_x(view_camera[0])-48, camera_get_view_y(view_camera[0])-48, objScreen.width+96, objScreen.height+96, true);
