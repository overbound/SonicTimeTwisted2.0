/// @description tr_load_localized_sprite(fname, imgnumb, removeback, smooth, xorig, yorig)
/// @param fname
/// @param  imgnumb
/// @param  removeback
/// @param  smooth
/// @param  xorig
/// @param  yorig
function tr_load_localized_sprite(argument0, argument1, argument2, argument3, argument4, argument5) {
