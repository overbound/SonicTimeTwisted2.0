/// @description input_clear_gamepad_backup_mappings(control, pad, inputType, inputCode, dir)
/// @param control
/// @param  pad
/// @param  inputType
/// @param  inputCode
/// @param  dir
function input_clear_gamepad_backup_mappings(argument0, argument1, argument2, argument3, argument4) {
