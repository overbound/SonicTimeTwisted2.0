/// @description  set_analog_controls_enabled(enabled_gamepad, enabled_touchscreen)
/// @param enabled_gamepad
/// @param  enabled_touchscreen
function set_analog_controls_enabled(argument0, argument1) {
	if (is_touchscreen) {
