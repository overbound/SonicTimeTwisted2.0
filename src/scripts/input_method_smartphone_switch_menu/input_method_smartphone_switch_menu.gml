/// @description  detect whether a touchscreen or a physical device is used in the menu and dynamically switch to it
function input_method_smartphone_switch_menu() {
	if(is_touchscreen)
	{
