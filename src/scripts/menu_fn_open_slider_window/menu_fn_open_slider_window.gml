/// @description  menu_fn_open_slider_window(sliderIndex, text, currentValue, min, max, suffix)
/// @param sliderIndex
/// @param  text
/// @param  currentValue
/// @param  min
/// @param  max
/// @param  suffix
function menu_fn_open_slider_window(argument0, argument1, argument2, argument3, argument4, argument5) {
