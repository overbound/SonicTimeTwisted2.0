	...
	switch(state)
	{
	    ...
	    default:
	        ...
	        if(scroll == round(scroll))
	        {
	            ...
	            if (actual_index > 0)
	            {
	                if(array_length(items[actual_index - 1]) == 4)
	                {
	            ...
	            { 
	                if(array_length(items[actual_index]) == 4)
	                {
	            ...
	            if (actual_index < array_length(items))
	            {
	                if(array_length(items[actual_index]) == 4)
	                {
	                    sprite_index_to_draw = 1;
	        ...
	        switch(state)
	        {
	            ...
	            case 27:
	                ...
	                if(state == 10)
	                {
	                    ...
	                    draw_set_font(objResources.fontHudMin);
	                    draw_set_colour(c_white);
	                    draw_text(internal__draw_menu_rect_x_center + 4, internal__draw_confirmation_rect_y1 + margin, string_hash_to_newline(confirmation_text));
	                ...
	                else
	                {
	                    if(state == 27)
	                    {
	                        ...
	                        draw_set_font(objResources.fontHudMin);
	                        draw_set_colour(c_white);
	                        draw_text_ext(internal__draw_menu_rect_x_center + 4, internal__draw_confirmation_rect_y1 + margin, string_hash_to_newline(confirmation_text), 16, objScreen.gui_width - 4*margin);
	                    ...
	                    else
	                    {
	                        ...
	                        else
	                        {
	                            if(state == 17)
	                            {
	                                ...
	                                draw_text(internal__draw_confirmation_rect_x_center, internal__draw_confirmation_rect_y2 - margin, string_hash_to_newline(tr_format(confirmation_yes_label, string(confirmation_cursor))));
	                                ...
	                                draw_rectangle(internal__draw_confirmation_rect_x_center - ((objScreen.width/2) - ((objScreen.width/2) - 101)), internal__draw_menu_rect_y_center - 9, internal__draw_confirmation_rect_x_center + ((objScreen.width/2) - ((objScreen.width/2) - 101)), internal__draw_menu_rect_y_center + 9, false);                         
	                                ...
	                                draw_rectangle(internal__draw_confirmation_rect_x_center - ((objScreen.width/2) - ((objScreen.width/2) - 100)), internal__draw_menu_rect_y_center - 8, internal__draw_confirmation_rect_x_center - ((objScreen.width/2) - ((objScreen.width/2) - 100)) + slider_length, internal__draw_menu_rect_y_center + 8, false);                         
	                            }
	                        }
	                    }
	                }
