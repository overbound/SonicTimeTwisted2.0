function draw_hud_score_time_rings(argument0, argument1, argument2, argument3) {
	...
	*/
	...
	if not objScreen.split_screen draw_text_colour(offset, argument3+8, string_hash_to_newline(objGameData.player_score[view_current]), c_white, c_white, c_white, c_white, 1);
	draw_text_colour(offset, argument3+40-(16*objScreen.split_screen), string_hash_to_newline(argument1), c_white, c_white, c_white, c_white, 1);
	draw_text_colour(offset, argument3+24-(16*objScreen.split_screen), string_hash_to_newline(time_stamp), c_white, c_white, c_white, c_white, 1);
	draw_set_halign(fa_left);
